...
namespace Diophant {
    ...
    data::N cast_integer_to_natural (const data::Z &);
    data::Z cast_natural_to_integer (const data::N &);
    ...
    data::byte uint8_plus (data::byte x, data::byte y);
    data::int8 int8_plus (data::int8 x, data::int8 y);

    data::byte uint8_minus (data::byte x, data::byte y);
    data::int8 int8_minus (data::int8 x, data::int8 y);

    data::byte uint8_times (data::byte x, data::byte y);
    data::int8 int8_times (data::int8 x, data::int8 y);

    data::uint16 uint16_plus (data::uint16 x, data::uint16 y);
    data::int16 int16_plus (data::int16 x, data::int16 y);

    data::uint16 uint16_minus (data::uint16 x, data::uint16 y);
    data::int16 int16_minus (data::int16 x, data::int16 y);

    data::uint16 uint16_times (data::uint16 x, data::uint16 y);
    data::int16 int16_times (data::int16 x, data::int16 y);

    data::uint32 uint32_plus (data::uint32 x, data::uint32 y);
    data::int32 int32_plus (data::int32 x, data::int32 y);

    data::uint32 uint32_minus (data::uint32 x, data::uint32 y);
    data::int32 int32_minus (data::int32 x, data::int32 y);

    data::uint32 uint32_times (data::uint32 x, data::uint32 y);
    data::int32 int32_times (data::int32 x, data::int32 y);
