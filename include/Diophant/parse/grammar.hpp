...
namespace tao_pegtl_grammar {
    ...
    template <typename atom> struct classic_lambda : seq<at<lambda_input>, lambda_input, ws, lambda_body<atom>> {};
    template <typename atom> struct compact_lambda : seq<lambda_open, ws, lambda_body<sor<anon_var, atom>>> {};
